...
var rif = /^[jJ|vV|gG|eE|pP|cC]{1,1}[0-9]{9}$/
...
function EsNumeroCC(text) {
    ...
    if (comboPersonalidad == null || (personalidad == 3 && (indice == 12 || indice == 13))) {
        if (text.value != null && text.value != "") {

            if (indice == 12 && (!Revisa(number, text.value) || text.value.length != 6)) { //CONSEJO COMUNAL
                alert("el formato del Nro MPPCPS debe ser 6 dígitos numéricos");
                text.value = "";
                text.focus();
                return false;
            }
            if (indice == 13 && (!Revisa(number, text.value) || text.value.length != 7)) { //COMUNA
                alert("el formato del Nro MPPCPS debe ser 7 dígitos numéricos");
                text.value = "";
                text.focus();
                return false;
            }
...
function EsAlfaNumCC(text) {
    ...
    if (comboPersonalidad == null || (personalidad == 3 && (indice == 12 || indice == 13))) {
        if (text.value != null && text.value != "") {
            ...
            if (indice == 12 && (!Revisa(alfanumerico, text.value) || text.value.length != 13)) { //CONSEJO COMUNAL
                alert("el formato del Nro Registro debe ser 13 caracteres alfanuméricos");
                text.value = "";
                text.focus();
                return false;
            }
            if (indice == 13 && (!Revisa(alfanumerico, text.value) || text.value.length != 8)) { //COMUNA
                alert("el formato del Nro Registro debe ser 8 caracteres alfanuméricos");
                text.value = "";
                text.focus();
                return false;
            }
...
function ValidDate(fecha) {
    if (fecha.value != "") {
        ...
        if ((dia > 31 || mes > 12 || dia <= 0 || mes <= 0) ||
            ...
            || (fec_err == 1) || ((mes == 4 || mes == 6 || mes == 9 || mes == 11) && dia > 30)) {
...
function ValidDateBeneficio(fecha) {
    if (fecha.value != "") {
        var fec_err = h_err = dia = mes = anio = hh = minutos = segundos = 0;
        var mesaux = 0;
        fec_err = (fecha.value.substring(2, 3) == "/" &&
        ...
        if ((dia > 31 || mes > 12 || dia <= 0 || mes <= 0) ||
            ...
            tipoBeneficio = document.forms[0].elements["tipoBeneficio.codigo"].value;
            if (tipoBeneficio == '1') {  //DECRETO 8.175 INCENTIVO DE LA CONSTRUCCION DE VIVIENDAS DIGNAS 
                if (!validarFechas(fecha.value, "03/05/2016") || !validarFechas("03/05/2011", fecha.value)) {
                    alert("La Fecha debe ser mayor a '03/05/2011' y menor a '03/05/2016'");
                    fecha.value = "";
                    fecha.focus();
                    return false;
                }
...
function ActivarBusqPreinscritos() {
    ...
    obtenerObjeto('comuna', null).value = 'N';
    obtenerObjeto('nodomiciliadocondireccion', null).value = 'N';
    obtenerObjeto('consejoeducativo', null).value = 'N';

    if (personalidad == '1' || personalidad == '2' || personalidad == '4' || personalidad == '6') { //NATURALES

        if (obtenerObjeto('personalidad', null).selectedIndex == 11) {			//SUCESION SIN CEDULA
            ...
            if (obtenerObjeto('personalidad', null).selectedIndex == 15 ||		//NATURALES NO RESIDENCIADOS
            ...
            } else {	//NATURALES NO RESIDENCIADOS CON BASE FIJA
                if (obtenerObjeto('personalidad', null).selectedIndex == 4 || obtenerObjeto('personalidad', null).selectedIndex == 5 || obtenerObjeto('personalidad', null).selectedIndex == 6) {
                    obtenerObjeto('nodomiciliadocondireccion', null).value = 'S';
                }
            }
            ...
            if (personalidad == '6')	//SUCESION CON CEDULA
                obtenerObjeto('labelfechanac', null).value = 'Fecha Fallecimiento';
            else
        ...
        switch (personalidad) {
            ...
            case '3':
                if (obtenerObjeto('personalidad', null).selectedIndex == 16) {			//JURIDICO NO DOMICILIADO
                    obtenerObjeto('noresidenciado', null).value = 'S';
                ...
                } else {																	//CONSEJO COMUNAL || COMUNAS
                    if (obtenerObjeto('personalidad', null).selectedIndex == 12 || obtenerObjeto('personalidad', null).selectedIndex == 13) {
                        if (obtenerObjeto('personalidad', null).selectedIndex == 12) {
                            obtenerObjeto('consejocomunal', null).value = 'S';
                        }
                        if (obtenerObjeto('personalidad', null).selectedIndex == 13) {
                            obtenerObjeto('comuna', null).value = 'S';
                        }
                        ...
                        if (obtenerObjeto('personalidad', null).selectedIndex == 14) {      //CONSEJOS EDUCATIVOS
                            obtenerObjeto('consejoeducativo', null).value = 'S';
                            ...
                            if (obtenerObjeto('personalidad', null).selectedIndex == 8) {      //JURIDICO NO DOMICILIADO CON BASE FIJA
                                obtenerObjeto('nodomiciliadocondireccion', null).value = 'S';
...
function ValidarBusquedaPreinscritos(reincorporar) {
    ...
    if (personalidad != null && personalidad != '') {
        ...
        if (personalidad == '1' || personalidad == '2' || personalidad == '4' || personalidad == '6') { //NATURALES
            ...
            if (personalidad == '3') { //JURIDICOS

                if (obtenerObjeto('personalidad', null).selectedIndex == 16) {  //PERSONA JURIDICA NO DOMICILIADA SIN ESTABLECIMIENTO PERMANENTE
                    if (razonSocial != '' && correo != '') {
                        return true;
                    }
                } else {
                    if (obtenerObjeto('personalidad', null).selectedIndex == 8) { //PERSONA JURIDICA NO DOMICILIADA CON ESTABLECIMIENTO PERMANENTE
                        if (fecha != '' && razonSocial != '') {
                            return true;
                        }
                    } else {
                        if (obtenerObjeto('personalidad', null).selectedIndex == 14) {  //CONSEJO EDUCATIVO
                            if (fecha != '' && razonSocial != '') {
                                return true;
                            }
                        } else {
                            if (fecha != '' && razonSocial != '' && registroProvidencia != '' && tomoGaceta != '') {
                                if (obtenerObjeto('personalidad', null).selectedIndex == 12) {  //CONSEJO COMUNAL
                                    if (!Revisa(number, registroProvidencia) || registroProvidencia.length != 6 || !Revisa(alfanumerico, tomoGaceta) || tomoGaceta.length != 13) {
                                        return false;
                                    }
                                } else {
                                    if (obtenerObjeto('personalidad', null).selectedIndex == 13) {  //COMUNA
                                        if (!Revisa(number, registroProvidencia) || registroProvidencia.length != 7 || !Revisa(alfanumerico, tomoGaceta) || tomoGaceta.length != 8) {
                                            return false;
                                        }
                                    }
                                }
...
function ValidarDocumentoRelacionesSuc(doc) {
    radioObj = document.forms[0].elements["tipodocumento"]
    radioLength = radioObj.length
    for (var i = 0; i < radioLength; i++) {
        if (radioObj[i].checked) {
            if (radioObj[i].value == "R") {
                if (doc.value != null && doc.value != "") {
                    if (!Revisa(rif, doc.value)) {
                        alert("el formato del RIF debe ser vV, eE, pP, jJ, gG, cC, seguido de nueve dígitos numéricos");
                        doc.focus();
                        return false;
                    }
                ...
                if (doc.value != null && doc.value != "") {
                    if (doc.value.length > 9 ||
                        (doc.value.charAt(0) != 'v' && doc.value.charAt(0) != 'V' && doc.value.charAt(0) != 'e' && doc.value.charAt(0) != 'E') ||
                        !Revisa(number, doc.value.substring(1, 9))) {
                        alert("Cedula Inválida. El formato de cédula debe ser vV, eE seguido de ocho dígitos numéricos, ej.: V12345678");
                        doc.focus();
                        return false;
                    }
