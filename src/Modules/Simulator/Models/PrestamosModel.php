...
/**
 * Model for Préstamos, Cuentas y Efectos por Pagar (Pasivos Deuda).
 */
class PrestamosModel
{
    ...
    public function getIntento(int $intentoId): ?array
    {
        try {
            ...
            error_log('[PrestamosModel::getIntento] ' . $e->getMessage());
            throw $e;
        }
    }
    ...
    public function getIntentoActivo(): ?array
    {
        try {
            ...
            error_log('[PrestamosModel::getIntentoActivo] ' . $e->getMessage());
            return null;
        }
    }
    ...
    public function guardarBorrador(int $intentoId, array $borrador, int $pasoActual, string $pasosCompletados = ''): bool
    {
        try {
            ...
            error_log('[PrestamosModel::guardarBorrador] ' . $e->getMessage());
            throw $e;
        }
    }
}
