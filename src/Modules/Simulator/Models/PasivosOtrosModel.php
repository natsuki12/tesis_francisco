...
/**
 * Model for Pasivos Deuda → Otros.
 */
class PasivosOtrosModel
{
    ...
    public function getIntento(int $intentoId): ?array
    {
        try {
            ...
            error_log('[PasivosOtrosModel::getIntento] ' . $e->getMessage());
            throw $e;
        }
    }
    ...
    public function getIntentoActivo(): ?array
    {
        try {
            ...
            error_log('[PasivosOtrosModel::getIntentoActivo] ' . $e->getMessage());
            return null;
        }
    }
    ...
    public function guardarBorrador(int $intentoId, array $borrador, int $pasoActual, string $pasosCompletados = ''): bool
    {
        try {
            ...
            error_log('[PasivosOtrosModel::guardarBorrador] ' . $e->getMessage());
            throw $e;
        }
    }
}
