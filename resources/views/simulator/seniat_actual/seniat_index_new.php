...
$activePage = 'inicio';
$extraCss = '<link rel="stylesheet" href="' . asset('css/simulator/seniat_actual/step_01_seniat_index.css') . '">';
...
<div class="simulation-wrapper">
    <header class="top-header">
        <img src="<?= asset('img/seniat-portal-nuevo/seniat-banner-header.jpg') ?>" alt="Gobierno Bolivariano"
            ...
            <ul class="seniat-navbar__menu">
                ...
                <li class="has-mega-dropdown dropdown-right" id="tourSistemasEnLinea">
                    ...
                    <div class="mega-dropdown">
                        <div class="mega-dropdown__section">
                            <ul>
                                <li><a href="<?= base_url('/simulador/inscripcion-rif') ?>">Inscripción de RIF</a></li>
                                <li><a href="<?= base_url('/simulador/consulta-rif') ?>">Consulta RIF</a></li>
            ...
            <div class="footer-bottom">
                ...
                <div class="social-icons">
                    ...
                    <a href="#" class="social-icon" title="YouTube">
                        <svg viewBox="0 0 24 24" width="24" height="24">
                            <path fill="currentColor"
                                d="M10,15L15.19,12L10,9V15M21.56,7.17C21.69,7.64 21.78,8.27 21.84,9.07C21.91,9.87 21.94,10.66 21.94,11.5C21.94,12.33 21.91,13.12 21.84,13.92C21.78,14.72 21.69,15.35 21.56,15.82C21.31,16.96 20.42,17.85 19.28,18.1C16.89,18.63 12,18.5 12,18.5C12,18.5 7.11,18.63 4.72,18.1C3.58,17.85 2.69,16.96 2.44,15.82C2.31,15.35 2.22,14.72 2.16,13.92C2.09,13.12 2.06,12.33 2.06,11.5C2.06,10.66 2.09,9.87 2.16,9.07C2.22,8.27 2.31,7.64 2.44,7.17C2.69,6.03 3.58,5.14 4.72,4.89C7.11,4.36 12,4.5 12,4.5C12,4.5 16.89,4.36 19.28,4.89C20.42,5.14 21.31,6.03 21.56,7.17Z" />
                        </svg>
                    </a>
                    <!-- TikTok -->
                    <a href="#" class="social-icon" title="TikTok">
                        <svg viewBox="0 0 24 24" width="24" height="24">
                            <path fill="currentColor"
                                d="M16.6 5.82C15.93 5.82 15.29 5.61 14.75 5.25C14.21 4.88 13.82 4.36 13.61 3.73C13.56 3.6 13.54 3.46 13.53 3.32H9.8V15C9.8 15.86 9.46 16.68 8.85 17.29C8.24 17.89 7.42 18.24 6.55 18.24C5.69 18.24 4.87 17.89 4.26 17.29C3.65 16.68 3.31 15.86 3.31 15C3.31 14.13 3.65 13.31 4.26 12.7C4.87 12.09 5.69 11.75 6.55 11.75C6.88 11.74 7.21 11.8 7.52 11.91V8.21C7.2 8.13 6.87 8.09 6.54 8.09C5.64 8.09 4.75 8.27 3.92 8.61C3.1 8.95 2.35 9.45 1.71 10.08C1.08 10.72 0.58 11.47 0.24 12.29C-0.1 13.12 -0.28 14.01 -0.28 14.91C-0.28 15.8 0.08 16.69 0.42 17.52C0.77 18.34 1.27 19.09 1.9 19.73C2.54 20.37 3.29 20.87 4.11 21.21C4.94 21.55 5.83 21.73 6.72 21.73C7.62 21.73 8.51 21.55 9.33 21.21C10.15 20.87 10.9 20.37 11.54 19.73C12.17 19.09 12.67 18.34 13.01 17.52C13.35 16.69 13.53 15.8 13.53 14.91V9.5C14.74 10.38 16.22 10.86 17.72 10.86V7.17C16.6 7.17 15.53 6.73 14.73 5.94C15.53 5.94 16.32 5.94 16.6 5.82Z"
                ...
                <div class="copyright-text">
                    2024 © Copyright - SENIAT. Servicio Nacional Integrado de Administración Aduanera y Tributaria -
...
<script src="<?= asset('js/simulator/seniat_actual/step_01_seniat_index.js') ?>"></script>
