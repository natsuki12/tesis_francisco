                ...
                <form _ngcontent-pgi-c66 novalidate class="lenletra" id="formTipoHerencia">
                    ...
                    <div _ngcontent-pgi-c66 class="row py-3">
                        <div _ngcontent-pgi-c66 class=col-sm-12>
                            <button _ngcontent-pgi-c66 type=submit class="btn btn-danger btn-sm">Guardar&nbsp;<i
                                    _ngcontent-pgi-c66 class=bi-save></i></button>
                        </div>
                    </div>
                </form>
                <br _ngcontent-pgi-c66>
                <table _ngcontent-pgi-c66 id="tablaTiposHerencia" class="table table-bordered table-striped table-sm lenletra">
