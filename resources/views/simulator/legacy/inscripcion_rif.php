            ...
            <table align="center" border="0" cellpadding="0" cellspacing="0" width="100%">
                <tr>
                    ...
                    <td align="left" valign="top" width="80%">
                        ...
                        <br />
                        <form
                            action="/rifcontribuyente/buscarpreinscrito.do;jsessionid=864fc90b43e0f7fca7046c62306a277c31d6e834fc2d936b7b0a4de2b2c9257a.e34PbhuMb3ePaO0La3ePaxqRb34Pe0"
                            method="post" name="BuscarInscritoRifForm"
                            onsubmit="return ValidarBusquedaPreinscritos(reincorporar);">
