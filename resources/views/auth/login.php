        ...
        <div class="auth-panel-inner">
            ...
            <?php if (!empty($flashMessage)): ?>
                <div class="alert alert--<?= $flashMessage['type'] === 'success' ? 'success' : 'error' ?>" role="alert">
                    <svg class="alert-icon" viewBox="0 0 24 24" width="16" height="16" fill="none" stroke="currentColor"
            ...
            <form class="auth-form" method="POST" action="<?= base_url('/login') ?>" novalidate>
                ...
                <div class="field">
                    ...
                    <div class="field-input-wrap">
                        ...
                        <input class="field-input" type="email" id="email" name="email" placeholder="tu@correo.com"
                ...
                <div class="field">
                    ...
                    <div class="field-input-wrap">
                        ...
                        <button type="button" class="toggle-password" aria-label="Mostrar contraseña"
                            ...
                            <svg class="eye-open" viewBox="0 0 24 24" width="18" height="18" fill="none"
                                stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round">
                                <path d="M1 12s4-8 11-8 11 8 11 8-4 8-11 8-11-8-11-8z" />
                                <circle cx="12" cy="12" r="3" />
                            </svg>
                            <svg class="eye-closed" viewBox="0 0 24 24" width="18" height="18" fill="none"
                                stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"
                                style="display:none">
                                <path
