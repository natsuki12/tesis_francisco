...
<div id="registro-spa-container">
    ...
    <div id="vista-terminos" class="spa-view <?= $mostrarDatos ? 'd-none' : '' ?>">
        ...
        <div class="spa-footer">
            <a href="<?= base_url('/') ?>" class="btn-spa btn-secondary">Declinar</a>
    ...
    <div id="vista-datos" class="spa-view <?= $mostrarDatos ? '' : 'd-none' ?>">
        ...
        <form id="form-datos-basicos" action="<?= base_url('/registro') ?>" method="POST">
            ...
            <?php if ($flashError): ?>
                <div
                    style="background-color: #f8d7da; color: #721c24; padding: 12px; border-radius: 6px; margin-bottom: 20px; border: 1px solid #f5c6cb; font-size: 0.9em; display: flex; align-items: center; gap: 10px;">
                    ...
                    <div>
                        ...
                        <?php elseif ($flashError === 'email_existe'): ?>
                            <strong>Correo en uso:</strong> Este correo ya está registrado. <a href="<?= base_url('/login') ?>"
                                style="color:#721c24; text-decoration:underline;">¿Iniciar sesión?</a>
                        <?php else: ?>
                ...
                <div class="data-form-container">
                    ...
                    <div class="form-group">
                        ...
                        <div class="custom-input-group">
                            ...
                            <input type="email" name="email" class="form-control-spa" placeholder="ejemplo@correo.com"
                                required value="<?= e($flashOld['email'] ?? $_SESSION['temp_user']['email'] ?? '') ?>">
                        </div>
                    </div>
